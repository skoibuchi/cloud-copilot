...
class Embedding:
    def __init__(self, embeddings=HuggingFaceEmbeddings(), vectorstore_class='faiss', connection_args={}, use_saved_store=True, user="default"):
        self.embeddings = embeddings
        self.vectorstore_class = vectorstore_class.lower()
        self.persist_directory = f'./vectorstore_{self.vectorstore_class}_{user}'
